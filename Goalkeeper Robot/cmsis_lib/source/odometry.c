...
//			Y_pos += (LRmeters * cos(theta) + FBmeters * sin(theta)) / 0.3258888276;
			...
			X_pos += (LRmeters * sin(theta) + FBmeters * cos(theta)) / 0.350330489; //0.3258888276
			Y_pos += (LRmeters * cos(theta) + FBmeters * (-sin(theta))) / 0.350330489;

	// displacement to position with compass heading
			X_poscmps += (LRmeters * sin((compassHeading*PI/180)) + FBmeters * cos(compassHeading*PI/180)) / 0.350330489;
			Y_poscmps += (LRmeters * cos((compassHeading*PI/180)) + FBmeters * (-sin(compassHeading*PI/180))) / 0.350330489;
}
