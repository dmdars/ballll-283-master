...
volatile int32_t TM_INT_RE_Count;
volatile int32_t secondCount;
volatile int32_t thirdCount;
volatile int32_t fourthCount;
volatile int32_t fifthCount;
volatile int32_t sixthCount;
