...
#define KUADRAN1 (a1+b1)/2
#define KUADRAN2 (a2+b2)/2
#define KUADRAN3 (a3+b3)/2
#define KUADRAN4 (a4+b4)/2
...
//#define KUADRAN1 (d1+e1+f1)/3
//#define KUADRAN2 (d2+e2+f2)/3
//#define KUADRAN3 (d3+e3+f3)/3
//#define KUADRAN4 (d4+e4+f4)/3
